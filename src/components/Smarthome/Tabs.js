...
function BatterieSysteme() {
  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl font-medium text-green-800 mb-6">Sonnenstrom rund um die Uhr nutzen</h1>
      <div className="mb-6">
        <Image
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-800 text-[18px]">
          Durch intelligente Hausautomation speichern Sie überschüssigen Solarstrom in Ihrem Batteriesystem und
          verwenden ihn genau dann, wenn Sie ihn benötigen.
        </p>
      </div>
    </div>
  );
...
function Ladestationen() {
  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl font-medium text-green-800 mb-6">Elektrofahrzeuge intelligent laden</h1>
      <div className="mb-6">
        <Image
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-800 text-[18px]">
          Zeit sparen – Nie wieder auf öffentliche Ladesäulen angewiesen sein; Günstigere Ladekosten – Laden Sie Ihr
          E-Auto mit eigenem Solarstrom; Schnellere Ladezeiten – Höhere Ladeleistung und effiziente Nutzung; Nutzen Sie
          Ihre Photovoltaikanlage als Energiequelle für Ihre Elektromobilität.
        </p>
      </div>
    </div>
  );
...
function Notstrombox() {
  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl font-medium text-green-800 mb-6">Unabhängig bei Stromausfällen</h1>
      <div className="mb-6">
        <Image
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-800 text-[18px]">
          Mit unseren Notstromlösungen können wichtige Geräte in Ihrem Haushalt auch bei einem Stromausfall weiter
          betrieben werden.
        </p>
      </div>
    </div>
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="space-y-3 pt-4 mt-6">
        <p className="text-gray-800 text-[18px]">
          Ein Smartmeter ermöglicht eine präzise Überwachung Ihrer Energieflüsse und hilft Ihnen, Ihren Eigenverbrauch
          zu optimieren: Energieproduktion & Verbrauch im Blick – Transparente Kontrolle Ihrer PV-Anlage, Fernsteuerung
          per App – Bequeme Steuerung Ihres Smarthome-Systems, Mehr Effizienz & Netzstabilität – Optimierte Nutzung von
          Solarstrom. Jetzt Smarthome & Smartmeter kombinieren!
        </p>
      </div>
    </div>
  );
