  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-9 md:pt-14">
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl text-gray-800 mb-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h2>
        <p>
          ...
          per E-Mail. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.
        </p>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl text-gray-800 mb-4">Recht auf Datenübertragbarkeit</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xltext-gray-800 mb-4">Recht auf Auskunft, Berichtigung, Sperrung, Löschung</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl text-gray-800 mb-4">SSL- bzw. TLS-Verschlüsselung</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl text-gray-800 mb-4">Kontaktformular</h2>
        <p className="mb-4">
